...
namespace DigiStore.Core.Services
{
    public class AdminService : IAdmin
    {
        ...
        public void DeleteAll(int id)
        {
            ...
            _context.RemoveRange(fieldCategories);
            _context.SaveChanges();
        }
        ...
        {
            return _context.FieldCategories.Any(f => f.FieldId == id && f.CategoryId == categoryId);
        }
        ...
        {
            return _context.Stores.Include(s => s.User).Where(s => s.MailActivate == true && s.MobileActivate == true).OrderByDescending(s => s.UserId).ToList();
        }
        ...
        {
            return _context.Banners.OrderByDescending(s => s.Id).ToList();
        }
        ...
        public int GetBrandNotShowCount()
        {
        ...
        public List<Coupon> GetCouponByStoreId(int id)
        {
        ...
        public void UpdateBanner(int id, string name, string defaultimage, string description, string size, int day, int price)
        {
            Banner banner = _context.Banners.Find(id);
            banner.Name = name;
            banner.DefaultImage = defaultimage;
        ...
        public void UpdateBrand(int id, string name, string image, bool notshow)
        {
            Brand brand = _context.Brands.Find(id);
            brand.Name = name;
            brand.Image = image;
        ...
        public void UpdateSetting(string name,string description, string keys, string api, string sender, string mail, string password)
        {
            Setting setting = _context.Settings.FirstOrDefault();
            setting.SiteName = name;
            setting.SiteDescription = description;
        ...
        public void UpdateSlider(int id, string title, string image, string description, bool notshow, int order)
        {
            Slider slider = _context.Sliders.Find(id);
            slider.Title = title;
            slider.Image = image;
        ...
        public void UpdateStoreCategory(int id, bool isactive, string desc)
        {
            ...
            storeCategory.Description = desc;
            _context.SaveChanges();
        }
