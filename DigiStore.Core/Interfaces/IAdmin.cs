...
namespace DigiStore.Core.Interfaces
{
    public interface IAdmin
    {
        ...
        void UpdateSetting(string name,string description, string keys, string api, string sender, string mail, string password);
        bool ExistsSetting();
        ...
        void UpdateBrand(int id, string name, string image, bool notshow);
        ...
        bool ExistsFieldCategory(int id, int categoryId);
        ...
        void UpdateSlider(int id, string title, string image, string description, bool notshow, int order);
        ...
        void UpdateBanner(int id, string name, string defaultimage, string description, string size, int day,int price);
        ...
        List<Coupon> GetCouponByStoreId(int id);
